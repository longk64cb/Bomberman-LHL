...
import uet.oop.bomberman.entities.staticobject.*;
import uet.oop.bomberman.entities.staticobject.Bomb.Bomb;
import uet.oop.bomberman.entities.staticobject.Powerup.BombItem;
import uet.oop.bomberman.entities.staticobject.Powerup.FlameItem;
import uet.oop.bomberman.entities.staticobject.Powerup.SpeedItem;
...
public class BombermanGame extends Application {
    private int WIDTH_BEGIN_WIDE = 0;
    private int HEIGHT_BEGIN_LONG =0;
    ...
    public void start(Stage stage) {
        ...
        stage.show();
        Media sound = new Media(new File("bomberman-starter-starter-2/res/sound/theme.mp3").toURI().toString());
        mediaPlayer = new MediaPlayer(sound);
        mediaPlayer.play();
//        createMap();
//
//        image = new Image(new File("bomberman-starter-starter-2/res/load_level/level_" + level + ".png").toURI().toString());
...
//        bomberman = new Bomber(1, 1, Sprite.player_down);
//        players.add(bomberman);
        Controller.keyHandle(scene);
...
//        System.out.println(moveThrough(0, 0));
        timer.start();
    }
...
//                }
    ...
    public static void loadMap(int n) throws FileNotFoundException {
        clearMap();
//        if (n != 1) {
//             image = new Image(new File("bomberman-starter-starter-2/res/load_level/level_" + n + ".png").toURI().toString());
//             imageView = new ImageView(image);
//            root.getChildren().add(imageView);
//            try {
//                TimeUnit.SECONDS.sleep(2);
...
//            root.getChildren().remove(imageView);
//        }
        FileInputStream fileInputStream = new FileInputStream("bomberman-starter-starter-2/res/levels/Level" + n + ".txt");
            ...
            for (int i = 0; i < line.length(); i++) {
                ...
                switch (line.charAt(i)) {
                    ...
                    case '2':
                        ...
                        break;
                    case '3':
                        object = new Minvo(i, j, Sprite.minvo_right1);
                        enemies.add(object);
                        break;
                    case '4':
                        object = new Doll(i, j, Sprite.doll_right1);
                        enemies.add(object);
                        break;
                    case '5':
                        object = new Kondoria(i, j, Sprite.kondoria_right1);
                        enemies.add(object);
                        break;
                    case 'b':
