...
public class Kondoria extends Enemy{
    ...
    protected void afterkilled() {
        setSprite(Sprite.finalMovingSprite(Sprite.kondoria_dead, Sprite.mob_dead1, Sprite.mob_dead2, Sprite.mob_dead3, vanishTime, 40));
    }
        ...
        if (!isKilled) {
            ...
            try {
                ...
                if (value_navigation / time_navigation == 1) {
                    Ramdom_navigation("Kondoria");
                    value_navigation = 0;
                    return;
                }
                if (!move(direction, true,"Kondoria")) {
                    Ramdom_navigation("Kondoria");
                }
